...
function cambiar() {
    let div = document.getElementById("listaTexto");
    let parrafos = div.querySelectorAll("p");
    let primerParrafo = parrafos[0];
    let ultimoParrafo = parrafos[parrafos.length - 1];
    div.insertBefore(ultimoParrafo , primerParrafo);
    div.appendChild(primerParrafo);
}